...
function App() {
  ...
  const passwordGenerator = useCallback((f) => {
    let pass = "";
    let str = "ABCDEFGHIJKLMNOPQRSTYWXYZabcdefghijklmnopqrstuvwxyz";
    if (numberAllowed) {
      str += "0123456789";
    }
    if (charAllowed) {
    ...
    <>
      <div className='w-full max-w-md mx-auto shadow-lg rounded-lg px-4 my-8 text-orange-500 bg-gray-500'>
        ...
        <div className='flex shadow rounded-lg overflow-hidden mb-4'>
          ...
          <button onClick={copyPasswordToClipboard} className='outline-none bg-blue-500 text-white'>copy</button>
        </div>
